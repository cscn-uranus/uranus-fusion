...
import com.uranus.fusion.tfr.cat062.dto.ifpl.FlightDataCoupleStatusEnum;
import com.uranus.fusion.tfr.cat062.dto.ifpl.IfplDTO;
import com.uranus.fusion.tfr.cat062.dto.ifpl.RoutePointDTO;
import com.uranus.fusion.tfr.cat062.dto.ifpl.RoutePointPassEnum;
import com.uranus.fusion.common.util.DateTypeEnum;
import com.uranus.fusion.common.util.DateUtil;
import com.uranus.fusion.common.fdexm.dom.AddmIfplDom;
import com.uranus.fusion.common.fdexm.dom.AddmRoutePointDom;
  ...
  private static AddmIfplDom toIfplDom(AddmDTO ifplAddmDTO) {
    ...
    try {
      ...
      if (AddmValidator.isValidAddmIfpl(ifplDom)) {
        ...
        log.error("从Addm中解析FlightData失败|非法的schema");
        return null;
      }

    } catch (IOException e) {
      log.error("从Addm中解析AddmIfplDom失败|文件IO错误");
      e.printStackTrace();
      return null;
    }
  }
