package com.uranus.fusion.common.asterix.aircraft;

import com.uranus.fusion.common.asterix.aircraft.fcu.FinalStateSelectedAltitude;
import com.uranus.fusion.common.asterix.aircraft.fcu.FinalStateSelectedAltitudeMapper;
import com.uranus.fusion.common.asterix.aircraft.fcu.SelectedAltitude;
import com.uranus.fusion.common.asterix.aircraft.fcu.SelectedAltitudeMapper;
import com.uranus.fusion.common.asterix.aircraft.identity.TargetAddress;
import com.uranus.fusion.common.asterix.aircraft.identity.TargetAddressMapper;
...
import com.uranus.fusion.common.asterix.aircraft.transponder.EmitterCategoryEnum;
import com.uranus.fusion.common.asterix.aircraft.transponder.EmitterCategoryMapper;
import com.uranus.fusion.common.asterix.aircraft.transponder.acas.AcasResolutionReport;
import com.uranus.fusion.common.asterix.aircraft.transponder.acas.AcasResolutionReportMapper;
import com.uranus.fusion.common.asterix.aircraft.transponder.adsb.StatusByAdsBroadcast;
import com.uranus.fusion.common.asterix.aircraft.transponder.adsb.StatusByAdsBroadcastMapper;
import com.uranus.fusion.common.asterix.aircraft.transponder.comm.CommAndStatusByModeSel;
import com.uranus.fusion.common.asterix.aircraft.transponder.comm.CommAndStatusByModeSelMapper;
import com.uranus.fusion.common.asterix.aircraft.transponder.modeselective.ModeSelMapper;
import com.uranus.fusion.common.asterix.aircraft.transponder.modeselective.ModeSelMbData;
import com.uranus.fusion.common.asterix.aircraft.nd.MagneticHeading;
import com.uranus.fusion.common.asterix.aircraft.nd.MagneticHeadingMapper;
import com.uranus.fusion.common.asterix.aircraft.nd.PositionMapper;
import com.uranus.fusion.common.asterix.aircraft.nd.PositionUncertainty;
import com.uranus.fusion.common.asterix.aircraft.nd.PositionUncertaintyMapper;
import com.uranus.fusion.common.asterix.aircraft.nd.TrajectoryIntentData;
import com.uranus.fusion.common.asterix.aircraft.nd.TrajectoryIntentStatus;
import com.uranus.fusion.common.asterix.aircraft.nd.TrajectoryMapper;
import com.uranus.fusion.common.asterix.aircraft.nd.VelocityUncertainty;
import com.uranus.fusion.common.asterix.aircraft.nd.VelocityUncertaintyMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.SpeedMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.BarometricPressureSetting;
import com.uranus.fusion.common.asterix.aircraft.pfd.BarometricPressureSettingMapper;
import com.uranus.fusion.common.asterix.measure.BarometricVerticalRate;
import com.uranus.fusion.common.asterix.aircraft.pfd.BarometricVerticalRateMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.GeometricAltitudeMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.GeometricVerticalRateMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.MeteorologicalData;
import com.uranus.fusion.common.asterix.aircraft.pfd.MeteorologicalDataMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.RollAngleMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.TrackAngleMapper;
import com.uranus.fusion.common.asterix.aircraft.pfd.TrackAngleRateMapper;
import com.uranus.fusion.common.asterix.measure.GeometricAltitude;
import com.uranus.fusion.common.asterix.measure.GeometricVerticalRate;
...
import com.uranus.fusion.common.asterix.measure.TrackAngle;
import com.uranus.fusion.common.asterix.measure.TrackAngleRate;
