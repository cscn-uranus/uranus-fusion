package com.uranus.fusion.asterix.track.status;

import com.uranus.fusion.asterix.track.status.type.AdsBroadcastConsistentStatusEnum;
import com.uranus.fusion.asterix.track.status.type.AgeStatusEnum;
import com.uranus.fusion.asterix.track.status.type.AmalgamationStatusEnum;
import com.uranus.fusion.asterix.track.status.type.CalculatedAltitudeSourceEnum;
import com.uranus.fusion.asterix.track.status.type.DataConflictStatusEnum;
import com.uranus.fusion.asterix.track.status.type.DataDuplicateStatusEnum;
import com.uranus.fusion.asterix.track.status.type.EarlyTrackIndicationEnum;
import com.uranus.fusion.asterix.track.status.type.EmergencyStatusEnum;
import com.uranus.fusion.asterix.track.status.type.FinalTrackIndicationEnum;
import com.uranus.fusion.asterix.track.status.type.FlightPlanCorrelatedStatusEnum;
import com.uranus.fusion.asterix.track.status.type.FplDataStatusEnum;
import com.uranus.fusion.asterix.track.status.type.InterrogationStatusEnum;
import com.uranus.fusion.asterix.track.status.type.MilitaryEmergencyStatusEnum;
import com.uranus.fusion.asterix.track.status.type.MilitaryIdentificationStatusEnum;
import com.uranus.fusion.asterix.track.status.type.MostReliableAltitudeStatusEnum;
import com.uranus.fusion.asterix.track.status.type.PotentialFalseStatusEnum;
import com.uranus.fusion.asterix.track.status.type.SensorSourceStatusEnum;
import com.uranus.fusion.asterix.track.status.type.ServiceUsedEnum;
import com.uranus.fusion.asterix.track.status.type.SlavePromotionStatusEnum;
import com.uranus.fusion.asterix.track.status.type.SpecialUsedCodeStatusEnum;
import com.uranus.fusion.asterix.track.status.type.SpiStatusEnum;
import com.uranus.fusion.asterix.track.status.type.SurveillanceDataStatusEnum;
import com.uranus.fusion.asterix.track.status.type.TargetTypeEnum;
import com.uranus.fusion.asterix.track.status.type.TrackCertaintyStatusEnum;
