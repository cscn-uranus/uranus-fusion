...
import com.uranus.fusion.asterix.uap.emitter.adsb.AdsBroadcastFlightStatusEnum;
import com.uranus.fusion.asterix.uap.emitter.adsb.BitSetStatusEnum;
import com.uranus.fusion.asterix.uap.emitter.adsb.OperationalEnum;
...
public class StatusByAdsbMapper {
  ...
  public static StatusByAdsb readStatusReportedByAdsB(List<Byte> uap, DataSpec dataSpec) {
