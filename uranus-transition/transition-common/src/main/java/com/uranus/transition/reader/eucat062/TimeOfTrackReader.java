 ...
 */
class TimeOfTrackReader {

  static TimeOfTrack read(List<Byte> message, FieldSpec fieldSpec) {

    // Time Of Track Information: frn=4, size=3
    final int frn = EuCat062Config.TIME_OF_TRACK_INFORMATION_FRN;
    final int size = EuCat062Config.TIME_OF_TRACK_INFORMATION_SIZE;
