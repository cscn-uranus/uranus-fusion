...
import com.uranus.transition.common.asterix.uap.shared.measure.altitude.AltitudeDiscrepancyStatusEnum;
import com.uranus.transition.common.asterix.uap.shared.measure.movement.LongitudinalMoveEnum;
import com.uranus.transition.common.asterix.uap.shared.measure.movement.ModeOfMovement;
import com.uranus.transition.common.asterix.uap.shared.measure.movement.TransversalMoveEnum;
...
/**
 * ModeOfMovementReader
 *
 * @author 肖鹏 tellxp@github.com date 2018/11/9
 */
class ModeOfMovementReader {

  static ModeOfMovement readModeOfMovement(List<Byte> uap, FieldSpec fieldSpec) {

    FpIndicator fpIndicator = fieldSpec.findFpIndicatorByFrn(EuCat062Config.MODE_OF_MOVEMENT_FRN);
    if (fpIndicator.getIndication().equals(FpIndicationEnum.PRESENCE)) {
      fpIndicator.setSize(EuCat062Config.MODE_OF_MOVEMENT_SIZE);

      int index = fieldSpec.calculateIndexByFrn(EuCat062Config.MODE_OF_MOVEMENT_FRN);
