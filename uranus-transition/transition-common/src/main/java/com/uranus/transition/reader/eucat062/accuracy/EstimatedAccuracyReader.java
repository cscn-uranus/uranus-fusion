...
import com.uranus.transition.common.asterix.uap.shared.accuracy.*;
...
public class EstimatedAccuracyReader {
  ...
  public static EstimatedAccuracy read(List<Byte> message, FieldSpec fieldSpec) {
    ...
    FpIndicator fpIndicator = fieldSpec.findFpIndicatorByFrn(EuCat062Config.ESTIMATED_ACCURACIES_FRN);
    if (fpIndicator.getIndication().equals(FpIndicationEnum.PRESENCE)) {
      int index = fieldSpec.calculateIndexByFrn(EuCat062Config.ESTIMATED_ACCURACIES_FRN);
