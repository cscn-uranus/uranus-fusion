...
public class FlightPlanRelatedDataMapper {
  ...
  public static FlightPlanRelatedData read(List<Byte> message, FieldSpec fieldSpec) {
    ...
    FpIndicator fpIndicator =
        fieldSpec.findFpIndicatorByFrn(EuCat062Config.FLIGHT_PLAN_RELATED_DATA_FRN);
    if (fpIndicator.getIndication().equals(FpIndicationEnum.PRESENCE)) {
      int beginIndex = fieldSpec.calculateIndexByFrn(EuCat062Config.FLIGHT_PLAN_RELATED_DATA_FRN);
