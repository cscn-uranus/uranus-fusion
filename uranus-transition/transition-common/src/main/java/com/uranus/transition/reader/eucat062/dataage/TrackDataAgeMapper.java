...
public class TrackDataAgeMapper {
  ...
  public static TrackDataAge read(List<Byte> message, FieldSpec fieldSpec) {
    ...
    FpIndicator fpIndicator = fieldSpec.findFpIndicatorByFrn(EuCat062Config.TRACK_DATA_AGES_FRN);
    if (fpIndicator.getIndication().equals(FpIndicationEnum.PRESENCE)) {
      int startIndex = fieldSpec.calculateIndexByFrn(EuCat062Config.TRACK_DATA_AGES_FRN);
