...
import com.uranus.fusion.common.asterix.uap.accuracy.EstimatedAccuracy;
import com.uranus.fusion.common.asterix.uap.aircraft.AircraftDerivedData;
import com.uranus.fusion.common.asterix.uap.datainfo.MeasuredInformation;
import com.uranus.fusion.common.asterix.uap.emitter.mode2.Mode2Code;
import com.uranus.fusion.common.asterix.uap.emitter.mode3.Mode3Code;
import com.uranus.fusion.common.asterix.uap.emitter.mode5.Mode5AndExtendedMode1;
import com.uranus.fusion.common.asterix.uap.flightplan.FlightPlanRelatedData;
import com.uranus.fusion.common.asterix.uap.identification.ServiceIdentification;
...
import com.uranus.fusion.common.asterix.uap.measure.altitude.RateOfClimbOrDescent;
import com.uranus.fusion.common.asterix.uap.measure.movement.ModeOfMovement;
import com.uranus.fusion.common.asterix.uap.measure.position.CartesianPosition;
...
import com.uranus.fusion.common.asterix.uap.measure.speed.CartesianVelocity;
import com.uranus.fusion.common.asterix.uap.track.ComposedTrackNumber;
import com.uranus.fusion.common.asterix.uap.track.TimeOfTrack;
import com.uranus.fusion.common.asterix.uap.track.TrackNumber;
import com.uranus.fusion.common.asterix.uap.track.TrackStatus;
import com.uranus.fusion.common.asterix.uap.track.status.SystemTrackUpdateAge;
import com.uranus.fusion.common.asterix.uap.track.status.TrackDataAge;
import com.uranus.fusion.common.asterix.uap.vehicle.TargetSizeAndOrientation;
import com.uranus.fusion.common.asterix.uap.vehicle.VehicleFleetIdentification;
import lombok.Data;
