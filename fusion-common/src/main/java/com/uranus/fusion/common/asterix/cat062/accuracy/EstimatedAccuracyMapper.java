package com.uranus.fusion.common.asterix.cat062.accuracy;

import com.uranus.fusion.common.asterix.cat062.Cat062Config;
import com.uranus.fusion.common.asterix.cat062.accuracy.sub.*;
import com.uranus.fusion.common.asterix.spec.*;
import com.uranus.fusion.common.asterix.uap.accuracy.*;
  ...
  public static EstimatedAccuracy read(List<Byte> message, FieldSpec fieldSpec) {
    ...
    if (fpIndicator.getIndication().equals(FpIndicationEnum.PRESENCE)) {
      ...
      Wgs84PositionAccuracy wgs84PositionAccuracy =
          Wgs84PositionAccuracyMapper.read(message, dataSpec);
      ...
      VerticalRateAccuracy verticalRateAccuracy =
          VerticalRateAccuracyMapper.read(message, dataSpec);
