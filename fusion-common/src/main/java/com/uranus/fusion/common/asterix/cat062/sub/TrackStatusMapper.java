...
import com.uranus.fusion.common.asterix.uap.datainfo.TargetTypeEnum;
import com.uranus.fusion.common.asterix.uap.emitter.InterrogationStatusEnum;
import com.uranus.fusion.common.asterix.uap.emitter.adsb.AdsBroadcastConsistentStatusEnum;
import com.uranus.fusion.common.asterix.uap.flightplan.FlightPlanCorrelatedStatusEnum;
import com.uranus.fusion.common.asterix.uap.flightplan.FplDataStatusEnum;
import com.uranus.fusion.common.asterix.uap.measure.altitude.CalculatedAltitudeSourceEnum;
import com.uranus.fusion.common.asterix.uap.measure.altitude.MostReliableAltitudeStatusEnum;
import com.uranus.fusion.common.asterix.uap.military.MilitaryEmergencyStatusEnum;
import com.uranus.fusion.common.asterix.uap.military.MilitaryIdentificationStatusEnum;
import com.uranus.fusion.common.asterix.uap.track.TrackStatus;
import com.uranus.fusion.common.asterix.uap.track.status.*;
...
public class TrackStatusMapper {
  ...
  private static void readThirdContent(Byte octet, TrackStatus trackStatus) {
    ...
    trackStatus.setModeSStatusEnum(
