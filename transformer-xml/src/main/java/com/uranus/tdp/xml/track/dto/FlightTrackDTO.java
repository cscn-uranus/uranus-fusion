package com.uranus.tdp.xml.track.dto;
...
public class FlightTrackDTO {
  ...
  private String flightTrackId = UUID.randomUUID().toString();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof FlightTrackDTO)) {
      return false;
    }
    FlightTrackDTO that = (FlightTrackDTO) o;
